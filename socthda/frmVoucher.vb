...
#Region "Declare"
    ...
    Friend WithEvents tbgDelivery As TabPage
    Friend WithEvents tbgUpdateInv As TabPage
    Friend WithEvents txtStt_rec_hd_update As TextBox
    Friend WithEvents lblTen_hd_update As Label
    Friend WithEvents Label13 As Label
    Friend WithEvents Label12 As Label
    Friend WithEvents Label11 As Label
    Friend WithEvents txtLoai_hd_phathanh As txtNumeric
    Private xInventory As clsInventory
    Private oEIInvoice As clsEIInvoice
#End Region
#Region "Form design"
    Public Sub New()
        MyBase.New()
...
#End Region
    ...
    Private Sub AddEChargeHandler()
        ...
        If (ObjectType.ObjTst(Strings.Trim(Me.cmdMa_nt.Text), modVoucher.oOption.Item("m_ma_nt0"), False) = 0) Then
            clsvoucher.clsVoucher.ChangeFormatColumn(col, StringType.FromObject(modVoucher.oVar.Item("m_ip_tien")))
            clsvoucher.clsVoucher.ChangeFormatColumn(column2, StringType.FromObject(modVoucher.oVar.Item("m_ip_tien")))
            clsvoucher.clsVoucher.ChangeFormatColumn(column4, StringType.FromObject(modVoucher.oVar.Item("m_ip_tien")))
    ...
    Public Sub AddNew()
        ...
        Me.pnContent.Text = ""
        clsvoucher.clsVoucher.ScatterMemvarBlankWithDefault(Me)
    ...
    '    End If
    'End Sub
    Private Function AfterUpdateSV(ByVal lcIDNumber As String, ByVal lcAction As String) As String
        If (ObjectType.ObjTst(Reg.GetRegistryKey("Edition"), "2", False) = 0) Then
            Return ""
        End If
        Return String.Concat(New String() {"EXEC fs_AfterUpdateSV '", lcIDNumber, "', '", lcAction, "', ", Strings.Trim(Conversions.ToString(Reg.GetRegistryKey("CurrUserID")))})
    End Function
            ...
            Do While (num <= num10)
                With modVoucher.tblCharge.Item(num)
                    If (Not IsDBNull(.Item("ma_cp")) AndAlso (StringType.StrCmp(Strings.Trim(StringType.FromObject(.Item("ma_cp"))), "", False) <> 0)) Then
                        ...
                        If (Trim(.Item("loai_cp")) = "1") Then
                            str5 = "cp_vc"
                            str3 = "cp_vc_nt"
                        ElseIf (Trim(.Item("loai_cp")) = "2") Then
                            str5 = "cp_bh"
                            str3 = "cp_bh_nt"
                        ElseIf (Trim(.Item("loai_cp")) = "3") Then
                            str5 = "cp_khac"
                            str3 = "cp_khac_nt"
                        End If
    ...
    '    End If
    'End Sub
    Private Function BeforUpdateSV(ByVal lcIDNumber As String, ByVal lcAction As String) As String
        If (ObjectType.ObjTst(Reg.GetRegistryKey("Edition"), "2", False) = 0) Then
            Return ""
        End If
        Return String.Concat(New String() {"EXEC fs_BeforUpdateSV '", lcIDNumber, "', '", lcAction, "', ", Strings.Trim(Conversions.ToString(Reg.GetRegistryKey("CurrUserID")))})
    End Function
    ...
    Public Sub Cancel()
        ...
        If (StringType.StrCmp(oVoucher.cAction, "New", False) = 0) Then
            ...
            If (Me.iOldMasterRow = -1) Then
                clsvoucher.clsVoucher.ScatterMemvarBlank(Me)
                modVoucher.tblDetail.RowFilter = "stt_rec = ''"
                Me.cmdNew.Focus()
                oVoucher.cAction = "Start"
            Else
                clsvoucher.clsVoucher.ScatterMemvar(modVoucher.tblMaster.Item(Me.iOldMasterRow), Me)
        ...
        Else
            ...
            Do While (currentRowIndex >= 0)
                ...
                currentRowIndex = (currentRowIndex + -1)
            Loop
            clsvoucher.clsVoucher.AppendFrom(modVoucher.tblDetail, Me.oldtblDetail)
            Me.RefrehForm()
            Me.cmdEdit.Focus()
            oVoucher.cAction = "View"
        End If
        ...
        ElseIf Me.oSecurity.GetStatusDelelete Then
            ...
            Else
                ...
                Else
                    ...
                    str4 = clsvoucher.clsVoucher.GenSQLDelete(Strings.Trim(StringType.FromObject(modVoucher.oVoucherRow.Item("m_ctdbf"))), cKey)
                End If
                ...
                Do While (num <= num3)
                    ...
                    str4 = (str4 & ChrW(13) & clsvoucher.clsVoucher.GenSQLDelete(cTable, cKey))
                    num += 1
                Loop
                ...
                End If
                str4 = Me.BeforUpdateSV(lcIDNumber, "Del") + ChrW(13) + str4
    ...
    Private Sub DeleteItem(ByVal sender As Object, ByVal e As EventArgs)
        If Fox.InList(oVoucher.cAction, New Object() {"New", "Edit"}) Then
            ...
            If ((((currentRowIndex >= 0) And (currentRowIndex < modVoucher.tblDetail.Count)) AndAlso Not Me.grdDetail.EndEdit(Me.grdDetail.TableStyles.Item(0).GridColumnStyles.Item(Me.grdDetail.CurrentCell.ColumnNumber), currentRowIndex, False)) AndAlso (ObjectType.ObjTst(Msg.Question(StringType.FromObject(modVoucher.oVar.Item("m_sure_dele")), 1), 1, False) = 0)) Then
                Me.grdDetail.Select(currentRowIndex)
                clsvoucher.clsVoucher.AllowCurrentCellChanged((Me.lAllowCurrentCellChanged), False)
                tblDetail.Item(currentRowIndex).Delete()
                If currentRowIndex = 0 Then
                    Try
                        Dim row As DataRow = Sql.GetRow(appConn, "dmvt", "ma_vt='" + tblDetail("0").Item("ma_vt") + "'")
                        If row("ma_thue") <> Me.txtMa_thue.Text Then
                            Me.txtMa_thue.Text = row.Item("ma_thue")
                            Me.txtThue_suat.Value = DoubleType.FromObject(Sql.GetValue((modVoucher.appConn), "dmthue", "thue_suat", "ma_thue = '" + row.Item("ma_thue") + "'"))
                            Me.txtTk_thue_co.Text = StringType.FromObject(Sql.GetValue((modVoucher.appConn), "dmthue", "tk_thue_co", "ma_thue = '" + row.Item("ma_thue") + "'"))
                            Me.RecalcTax(2)
                            Me.UpdateList()
                        End If
                ...
                Me.RecalcTax(0, 2)
                Me.UpdateList()
                clsvoucher.clsVoucher.AllowCurrentCellChanged((Me.lAllowCurrentCellChanged), True)
            End If
        End If
    End Sub
    ...
    Public Sub EDFC()
        If (ObjectType.ObjTst(Me.cmdMa_nt.Text, modVoucher.oOption.Item("m_ma_nt0"), False) = 0) Then
            ...
            clsvoucher.clsVoucher.ChangeFormatColumn(Me.colGia_nt2, StringType.FromObject(modVoucher.oVar.Item("m_ip_gia")))
            clsvoucher.clsVoucher.ChangeFormatColumn(Me.colGia_nt, StringType.FromObject(modVoucher.oVar.Item("m_ip_gia")))
            clsvoucher.clsVoucher.ChangeFormatColumn(Me.colTien_nt2, StringType.FromObject(modVoucher.oVar.Item("m_ip_tien")))
            clsvoucher.clsVoucher.ChangeFormatColumn(Me.colTien_nt, StringType.FromObject(modVoucher.oVar.Item("m_ip_tien")))
            clsvoucher.clsVoucher.ChangeFormatColumn(Me.colCk_nt, StringType.FromObject(modVoucher.oVar.Item("m_ip_tien")))
            clsvoucher.clsVoucher.ChangeFormatColumn(Me.colCTien_cp_nt, StringType.FromObject(modVoucher.oVar.Item("m_ip_tien")))
        ...
        Else
            ...
            clsvoucher.clsVoucher.ChangeFormatColumn(Me.colGia_nt, StringType.FromObject(modVoucher.oVar.Item("m_ip_gia_nt")))
            clsvoucher.clsVoucher.ChangeFormatColumn(Me.colTien_nt, StringType.FromObject(modVoucher.oVar.Item("m_ip_tien_nt")))
            clsvoucher.clsVoucher.ChangeFormatColumn(Me.colGia_nt2, StringType.FromObject(modVoucher.oVar.Item("m_ip_gia_nt")))
            clsvoucher.clsVoucher.ChangeFormatColumn(Me.colTien_nt2, StringType.FromObject(modVoucher.oVar.Item("m_ip_tien_nt")))
            clsvoucher.clsVoucher.ChangeFormatColumn(Me.colCk_nt, StringType.FromObject(modVoucher.oVar.Item("m_ip_tien_nt")))
            clsvoucher.clsVoucher.ChangeFormatColumn(Me.colCTien_cp_nt, StringType.FromObject(modVoucher.oVar.Item("m_ip_tien_nt")))
    ...
    Private Sub EditAllocatedCharge(ByVal sender As Object, ByVal e As EventArgs)
        If Fox.InList(oVoucher.cAction, New Object() {"New", "Edit"}) Then
            ...
            Me.pn = clsvoucher.clsVoucher.AddStb(Me.frmView)
    ...
    Private Sub frmVoucher_Load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim lib4 As New DirLib(Me.txtMa_nvbh, Me.lblTen_nvbh, modVoucher.sysConn, modVoucher.appConn, "dmnvbh", "ma_nvbh", "ten_nvbh", "SaleEmployee", "1=1", False, Me.cmdEdit)
        ...
        Dim oCustTax As New DirLib(Me.txtFcode1, Me.lblFname1, modVoucher.sysConn, modVoucher.appConn, "dmkh", "ma_kh", "ten_kh", "Customer", str2, True, Me.cmdEdit)
        ...
        clsvoucher.clsVoucher.ChangeFormatColumn(Me.colSo_luong, StringType.FromObject(modVoucher.oVar.Item("m_ip_sl")))
        ...
        Dim hddt As New DirLib(Me.txtStt_rec_hd_update, lblTen_hd_update, sysConn, appConn, "vctgt20", "stt_rec", "ten_hddt", "EOutputVAT", "1=1", True, Me.cmdEdit)
    End Sub
    ...
    Private Sub grdCharge_CurrentCellChanged(ByVal sender As Object, ByVal e As EventArgs) Handles grdCharge.CurrentCellChanged
        ...
        If sLeft = "TIEN_CP_NT" Then
            ...
            clsvoucher.clsVoucher.SetOldValue((oOldObject), oValue)
    ...
    Private Sub grdDetail_CurrentCellChanged(ByVal sender As Object, ByVal e As EventArgs) Handles grdDetail.CurrentCellChanged
        ...
        Select Case sLeft
            Case "MA_VT"
                ...
                clsvoucher.clsVoucher.SetOldValue((cOldItem), oValue)
    ...
    Private Sub InitCharge()
        Dim grdFill As DataGrid = grdCharge
        Fill2Grid.Fill(sysConn, tblCharge, grdFill, tbsCharge, tbcCharge, "SVCharge")
        grdCharge = grdFill
...
#Region "Form Init"
    ...
    Private Sub InitializeComponent()
        ...
        Me.tbgDelivery = New System.Windows.Forms.TabPage()
        Me.tbgUpdateInv = New System.Windows.Forms.TabPage()
        Me.txtStt_rec_hd_update = New System.Windows.Forms.TextBox()
        Me.lblTen_hd_update = New System.Windows.Forms.Label()
        Me.Label13 = New System.Windows.Forms.Label()
        Me.Label12 = New System.Windows.Forms.Label()
        Me.Label11 = New System.Windows.Forms.Label()
        Me.txtLoai_hd_phathanh = New libscontrol.txtNumeric()
        ...
        Me.cmdSave.Location = New System.Drawing.Point(29, 519)
        ...
        Me.cmdNew.Location = New System.Drawing.Point(101, 519)
        ...
        Me.cmdPrint.Location = New System.Drawing.Point(173, 519)
        ...
        Me.cmdEdit.Location = New System.Drawing.Point(245, 519)
        ...
        Me.cmdDelete.Location = New System.Drawing.Point(317, 519)
        ...
        Me.cmdView.Location = New System.Drawing.Point(389, 519)
        ...
        Me.cmdSearch.Location = New System.Drawing.Point(461, 519)
        ...
        Me.cmdClose.Location = New System.Drawing.Point(533, 519)
        ...
        Me.cmdOption.Location = New System.Drawing.Point(877, 519)
        ...
        Me.cmdTop.Location = New System.Drawing.Point(901, 519)
        ...
        Me.cmdPrev.Location = New System.Drawing.Point(925, 519)
        ...
        Me.cmdNext.Location = New System.Drawing.Point(949, 519)
        ...
        Me.cmdBottom.Location = New System.Drawing.Point(973, 519)
        ...
        Me.lblMa_dvcs.Location = New System.Drawing.Point(442, 554)
        ...
        Me.txtMa_dvcs.Location = New System.Drawing.Point(499, 554)
        ...
        Me.lblTen_dvcs.Location = New System.Drawing.Point(624, 554)
        ...
        Me.lblSo_ct.Location = New System.Drawing.Point(752, 8)
        ...
        Me.txtSo_ct.Location = New System.Drawing.Point(877, 6)
        ...
        Me.txtTy_gia.Location = New System.Drawing.Point(877, 103)
        ...
        Me.lblNgay_lct.Location = New System.Drawing.Point(752, 57)
        ...
        Me.lblNgay_ct.Location = New System.Drawing.Point(752, 81)
        ...
        Me.lblTy_gia.Location = New System.Drawing.Point(752, 105)
        ...
        Me.txtNgay_ct.Location = New System.Drawing.Point(877, 78)
        ...
        Me.cmdMa_nt.Location = New System.Drawing.Point(829, 103)
        Me.cmdMa_nt.Name = "cmdMa_nt"
        Me.cmdMa_nt.Size = New System.Drawing.Size(43, 23)
        ...
        Me.tbDetail.Controls.Add(Me.tbgDelivery)
        Me.tbDetail.Controls.Add(Me.tbgUpdateInv)
        Me.tbDetail.ImeMode = System.Windows.Forms.ImeMode.NoControl
        Me.tbDetail.Location = New System.Drawing.Point(19, 188)
        Me.tbDetail.Name = "tbDetail"
        Me.tbDetail.SelectedIndex = 0
        Me.tbDetail.Size = New System.Drawing.Size(983, 239)
        ...
        Me.tpgDetail.Size = New System.Drawing.Size(975, 210)
        ...
        Me.grdDetail.Size = New System.Drawing.Size(976, 206)
        ...
        Me.tbgOther.Controls.Add(Me.lblFname1)
        Me.tbgOther.Controls.Add(Me.txtFcode1)
        ...
        Me.tbgOther.Controls.Add(Me.txtTen_vtthue)
        Me.tbgOther.Controls.Add(Me.lblTen_vtthue)
        ...
        Me.tbgOther.Size = New System.Drawing.Size(770, 217)
        ...
        Me.lblFname1.Location = New System.Drawing.Point(232, 10)
        Me.lblFname1.Name = "lblFname1"
        Me.lblFname1.Size = New System.Drawing.Size(77, 17)
        Me.lblFname1.TabIndex = 134
        ...
        Me.txtFcode1.Location = New System.Drawing.Point(106, 6)
        ...
        Me.txtGhi_chuthue.Location = New System.Drawing.Point(106, 30)
        Me.txtGhi_chuthue.Name = "txtGhi_chuthue"
        Me.txtGhi_chuthue.Size = New System.Drawing.Size(241, 22)
        Me.txtGhi_chuthue.TabIndex = 1
        ...
        Me.lblT_tc_tt.Location = New System.Drawing.Point(2, 129)
        Me.lblT_tc_tt.Name = "lblT_tc_tt"
        Me.lblT_tc_tt.Size = New System.Drawing.Size(68, 17)
        ...
        Me.lblT_tc_thue.Location = New System.Drawing.Point(2, 105)
        Me.lblT_tc_thue.Name = "lblT_tc_thue"
        Me.lblT_tc_thue.Size = New System.Drawing.Size(73, 17)
        ...
        Me.txtT_tc_tt.Location = New System.Drawing.Point(227, 127)
        Me.txtT_tc_tt.MaxLength = 10
        Me.txtT_tc_tt.Name = "txtT_tc_tt"
        Me.txtT_tc_tt.Size = New System.Drawing.Size(120, 22)
        ...
        Me.txtT_tc_tt_nt.Location = New System.Drawing.Point(106, 127)
        Me.txtT_tc_tt_nt.MaxLength = 13
        Me.txtT_tc_tt_nt.Name = "txtT_tc_tt_nt"
        Me.txtT_tc_tt_nt.Size = New System.Drawing.Size(120, 22)
        ...
        Me.txtT_tc_thue.Location = New System.Drawing.Point(227, 103)
        Me.txtT_tc_thue.MaxLength = 10
        Me.txtT_tc_thue.Name = "txtT_tc_thue"
        Me.txtT_tc_thue.Size = New System.Drawing.Size(120, 22)
        ...
        Me.txtT_tc_thue_nt.Location = New System.Drawing.Point(106, 103)
        Me.txtT_tc_thue_nt.MaxLength = 13
        Me.txtT_tc_thue_nt.Name = "txtT_tc_thue_nt"
        Me.txtT_tc_thue_nt.Size = New System.Drawing.Size(120, 22)
        ...
        Me.txtT_tc_tien2.Location = New System.Drawing.Point(227, 78)
        Me.txtT_tc_tien2.MaxLength = 10
        Me.txtT_tc_tien2.Name = "txtT_tc_tien2"
        Me.txtT_tc_tien2.Size = New System.Drawing.Size(120, 22)
        ...
        Me.lblT_tc_tien2.Location = New System.Drawing.Point(2, 81)
        Me.lblT_tc_tien2.Name = "lblT_tc_tien2"
        Me.lblT_tc_tien2.Size = New System.Drawing.Size(109, 17)
        ...
        Me.txtTen_vtthue.Location = New System.Drawing.Point(114, 189)
        Me.txtTen_vtthue.Name = "txtTen_vtthue"
        Me.txtTen_vtthue.Size = New System.Drawing.Size(404, 22)
        Me.txtTen_vtthue.TabIndex = 4
        ...
        Me.lblTen_vtthue.Location = New System.Drawing.Point(8, 192)
        Me.lblTen_vtthue.Name = "lblTen_vtthue"
        Me.lblTen_vtthue.Size = New System.Drawing.Size(81, 17)
        ...
        Me.txtT_tc_tien_nt2.Location = New System.Drawing.Point(106, 78)
        Me.txtT_tc_tien_nt2.MaxLength = 13
        Me.txtT_tc_tien_nt2.Name = "txtT_tc_tien_nt2"
        Me.txtT_tc_tien_nt2.Size = New System.Drawing.Size(120, 22)
        ...
        Me.lblT_km.Location = New System.Drawing.Point(368, 129)
        Me.lblT_km.Name = "lblT_km"
        Me.lblT_km.Size = New System.Drawing.Size(98, 17)
        ...
        Me.lblT_thue_km.Location = New System.Drawing.Point(368, 105)
        Me.lblT_thue_km.Name = "lblT_thue_km"
        Me.lblT_thue_km.Size = New System.Drawing.Size(95, 17)
        ...
        Me.txtT_km.Location = New System.Drawing.Point(636, 127)
        Me.txtT_km.MaxLength = 10
        Me.txtT_km.Name = "txtT_km"
        Me.txtT_km.Size = New System.Drawing.Size(120, 22)
        ...
        Me.txtT_km_nt.Location = New System.Drawing.Point(515, 127)
        Me.txtT_km_nt.MaxLength = 13
        Me.txtT_km_nt.Name = "txtT_km_nt"
        Me.txtT_km_nt.Size = New System.Drawing.Size(120, 22)
        ...
        Me.txtT_thue_km.Location = New System.Drawing.Point(636, 103)
        Me.txtT_thue_km.MaxLength = 10
        Me.txtT_thue_km.Name = "txtT_thue_km"
        Me.txtT_thue_km.Size = New System.Drawing.Size(120, 22)
        ...
        Me.txtT_thue_km_nt.Location = New System.Drawing.Point(515, 103)
        Me.txtT_thue_km_nt.MaxLength = 13
        Me.txtT_thue_km_nt.Name = "txtT_thue_km_nt"
        Me.txtT_thue_km_nt.Size = New System.Drawing.Size(120, 22)
        ...
        Me.txtT_tien_km.Location = New System.Drawing.Point(636, 78)
        Me.txtT_tien_km.MaxLength = 10
        Me.txtT_tien_km.Name = "txtT_tien_km"
        Me.txtT_tien_km.Size = New System.Drawing.Size(120, 22)
        ...
        Me.lblT_tien_km.Location = New System.Drawing.Point(368, 81)
        Me.lblT_tien_km.Name = "lblT_tien_km"
        Me.lblT_tien_km.Size = New System.Drawing.Size(90, 17)
        ...
        Me.txtT_tien_km_nt.Location = New System.Drawing.Point(515, 78)
        Me.txtT_tien_km_nt.MaxLength = 13
        Me.txtT_tien_km_nt.Name = "txtT_tien_km_nt"
        Me.txtT_tien_km_nt.Size = New System.Drawing.Size(120, 22)
        ...
        Me.txtT_tien.Location = New System.Drawing.Point(636, 6)
        ...
        Me.lblT_Tien.Location = New System.Drawing.Point(368, 8)
        Me.lblT_Tien.Name = "lblT_Tien"
        Me.lblT_Tien.Size = New System.Drawing.Size(130, 17)
        ...
        Me.txtT_tien_nt.Location = New System.Drawing.Point(515, 6)
        ...
        'chkCk_thue_yn
        '
        Me.chkCk_thue_yn.Location = New System.Drawing.Point(106, 157)
        Me.chkCk_thue_yn.Name = "chkCk_thue_yn"
        Me.chkCk_thue_yn.Size = New System.Drawing.Size(192, 18)
        Me.chkCk_thue_yn.TabIndex = 3
        ...
        Me.txtT_ck.Location = New System.Drawing.Point(636, 30)
        ...
        Me.lblTien_ck.Location = New System.Drawing.Point(368, 32)
        ...
        Me.txtT_ck_nt.Location = New System.Drawing.Point(515, 30)
        ...
        Me.lvlT_cp.Location = New System.Drawing.Point(368, 57)
        Me.lvlT_cp.Name = "lvlT_cp"
        Me.lvlT_cp.Size = New System.Drawing.Size(51, 17)
        ...
        Me.txtT_cp_nt.Location = New System.Drawing.Point(515, 54)
        ...
        Me.txtT_cp.Location = New System.Drawing.Point(636, 54)
        ...
        Me.lblTk_ck.Location = New System.Drawing.Point(2, 57)
        Me.lblTk_ck.Name = "lblTk_ck"
        Me.lblTk_ck.Size = New System.Drawing.Size(93, 17)
        ...
        Me.txtTk_ck.Location = New System.Drawing.Point(106, 54)
        Me.txtTk_ck.Name = "txtTk_ck"
        Me.txtTk_ck.Size = New System.Drawing.Size(120, 22)
        Me.txtTk_ck.TabIndex = 2
        ...
        Me.tbgCharge.Size = New System.Drawing.Size(770, 217)
        ...
        Me.grdCharge.Size = New System.Drawing.Size(771, 213)
        Me.grdCharge.TabIndex = 1
        Me.grdCharge.Tag = "L035"
        '
        'tbgDelivery
        '
        Me.tbgDelivery.BackColor = System.Drawing.SystemColors.Control
        Me.tbgDelivery.Location = New System.Drawing.Point(4, 25)
        Me.tbgDelivery.Name = "tbgDelivery"
        Me.tbgDelivery.Size = New System.Drawing.Size(770, 217)
        Me.tbgDelivery.TabIndex = 4
        Me.tbgDelivery.Tag = "L800"
        Me.tbgDelivery.Text = "Thông tin giao hàng"
        '
        'tbgUpdateInv
        '
        Me.tbgUpdateInv.BackColor = System.Drawing.SystemColors.Control
        Me.tbgUpdateInv.Controls.Add(Me.txtStt_rec_hd_update)
        Me.tbgUpdateInv.Controls.Add(Me.lblTen_hd_update)
        Me.tbgUpdateInv.Controls.Add(Me.Label13)
        Me.tbgUpdateInv.Controls.Add(Me.Label12)
        Me.tbgUpdateInv.Controls.Add(Me.Label11)
        Me.tbgUpdateInv.Controls.Add(Me.txtLoai_hd_phathanh)
        Me.tbgUpdateInv.Location = New System.Drawing.Point(4, 25)
        Me.tbgUpdateInv.Name = "tbgUpdateInv"
        Me.tbgUpdateInv.Size = New System.Drawing.Size(770, 217)
        Me.tbgUpdateInv.TabIndex = 5
        Me.tbgUpdateInv.Tag = "L808"
        Me.tbgUpdateInv.Text = "Kiểu phát hành hóa đơn"
        '
        'txtStt_rec_hd_update
        '
        Me.txtStt_rec_hd_update.BackColor = System.Drawing.Color.White
        Me.txtStt_rec_hd_update.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper
        Me.txtStt_rec_hd_update.Location = New System.Drawing.Point(167, 30)
        Me.txtStt_rec_hd_update.Name = "txtStt_rec_hd_update"
        Me.txtStt_rec_hd_update.Size = New System.Drawing.Size(126, 22)
        Me.txtStt_rec_hd_update.TabIndex = 77
        Me.txtStt_rec_hd_update.Tag = "FCCF"
        Me.txtStt_rec_hd_update.Text = "TXTSTT_REC_HD_UPDATE"
        '
        'lblTen_hd_update
        '
        Me.lblTen_hd_update.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
            Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.lblTen_hd_update.AutoSize = True
        Me.lblTen_hd_update.Location = New System.Drawing.Point(305, 35)
        Me.lblTen_hd_update.Name = "lblTen_hd_update"
        Me.lblTen_hd_update.Size = New System.Drawing.Size(123, 17)
        Me.lblTen_hd_update.TabIndex = 81
        Me.lblTen_hd_update.Tag = "FCRF"
        Me.lblTen_hd_update.Text = "lblTen_hd_update"
        '
        'Label13
        '
        ...
        Me.Label13.Tag = "L810"
        Me.Label13.Text = "Cap nhat cho hoa don"
        '
        'Label12
        '
        ...
        Me.Label12.Location = New System.Drawing.Point(214, 8)
        Me.Label12.Name = "Label12"
        Me.Label12.Size = New System.Drawing.Size(251, 17)
        Me.Label12.TabIndex = 79
        Me.Label12.Tag = "L809"
        Me.Label12.Text = "0 - Không, 1 - Điều chỉnh, 2 - Thay thế"
        '
        'Label11
        '
        ...
        Me.Label11.Tag = "L808"
        Me.Label11.Text = "Kieu phat hanh hoa don"
        '
        'txtLoai_hd_phathanh
        '
        Me.txtLoai_hd_phathanh.BackColor = System.Drawing.Color.White
        Me.txtLoai_hd_phathanh.ForeColor = System.Drawing.Color.Black
        Me.txtLoai_hd_phathanh.Format = "0"
        Me.txtLoai_hd_phathanh.Location = New System.Drawing.Point(167, 3)
        Me.txtLoai_hd_phathanh.MaxLength = 2
        Me.txtLoai_hd_phathanh.Name = "txtLoai_hd_phathanh"
        Me.txtLoai_hd_phathanh.Size = New System.Drawing.Size(31, 22)
        Me.txtLoai_hd_phathanh.TabIndex = 76
        Me.txtLoai_hd_phathanh.Tag = "FN"
        Me.txtLoai_hd_phathanh.Text = "0"
        Me.txtLoai_hd_phathanh.TextAlign = System.Windows.Forms.HorizontalAlignment.Right
        Me.txtLoai_hd_phathanh.Value = 0R
        '
        'txtMa_nvbh
        '
        ...
        Me.txtMa_nvbh.Location = New System.Drawing.Point(115, 78)
        ...
        Me.lblMa_nv.Location = New System.Drawing.Point(10, 83)
        Me.lblMa_nv.Name = "lblMa_nv"
        Me.lblMa_nv.Size = New System.Drawing.Size(46, 17)
        ...
        Me.lblTen_nvbh.Location = New System.Drawing.Point(240, 83)
        ...
        Me.txtT_tien2.Location = New System.Drawing.Point(877, 440)
        ...
        Me.txtT_tien_nt2.Location = New System.Drawing.Point(752, 440)
        ...
        Me.txtStatus.Location = New System.Drawing.Point(29, 549)
        ...
        Me.lblStatus.Location = New System.Drawing.Point(752, 129)
        ...
        Me.lblStatusMess.Location = New System.Drawing.Point(77, 551)
        ...
        'txtKeyPress
        '
        Me.txtKeyPress.Location = New System.Drawing.Point(509, 157)
        ...
        Me.cboStatus.Location = New System.Drawing.Point(829, 127)
        ...
        Me.cboAction.Location = New System.Drawing.Point(829, 151)
        ...
        Me.lblAction.Location = New System.Drawing.Point(752, 153)
        ...
        Me.lblMa_kh.Location = New System.Drawing.Point(10, 8)
        ...
        Me.txtMa_kh.Location = New System.Drawing.Point(115, 6)
        ...
        Me.lblTen_kh.Location = New System.Drawing.Point(240, 8)
        ...
        Me.lblTotal.Location = New System.Drawing.Point(531, 442)
        ...
        Me.lblMa_tt.Location = New System.Drawing.Point(10, 153)
        ...
        Me.txtMa_tt.Enabled = False
        Me.txtMa_tt.Location = New System.Drawing.Point(115, 151)
        ...
        Me.lblTen_tt.Location = New System.Drawing.Point(154, 153)
        Me.lblTen_tt.Name = "lblTen_tt"
        Me.lblTen_tt.Size = New System.Drawing.Size(105, 17)
        ...
        Me.lblTen.Location = New System.Drawing.Point(701, 554)
        ...
        Me.txtDien_giai.Location = New System.Drawing.Point(115, 54)
        Me.txtDien_giai.Name = "txtDien_giai"
        Me.txtDien_giai.Size = New System.Drawing.Size(405, 22)
        ...
        Me.txtT_so_luong.Location = New System.Drawing.Point(627, 440)
        ...
        Me.txtLoai_ct.Location = New System.Drawing.Point(634, 554)
        ...
        Me.txtMa_gd.Location = New System.Drawing.Point(115, 127)
        Me.txtMa_gd.Name = "txtMa_gd"
        Me.txtMa_gd.Size = New System.Drawing.Size(36, 22)
        Me.txtMa_gd.TabIndex = 5
        ...
        Me.lblMa_gd.Location = New System.Drawing.Point(10, 128)
        ...
        Me.lblTen_gd.Location = New System.Drawing.Point(154, 129)
        ...
        Me.lblT_thue.Location = New System.Drawing.Point(637, 466)
        ...
        Me.txtT_thue_nt.Location = New System.Drawing.Point(752, 464)
        ...
        Me.txtT_thue.Location = New System.Drawing.Point(877, 464)
        ...
        Me.lblT_tt.Location = New System.Drawing.Point(637, 490)
        ...
        Me.txtT_tt_nt.Location = New System.Drawing.Point(752, 488)
        ...
        Me.txtT_tt.Location = New System.Drawing.Point(877, 488)
        ...
        Me.txtSo_seri.Location = New System.Drawing.Point(877, 30)
        Me.txtSo_seri.Name = "txtSo_seri"
        Me.txtSo_seri.Size = New System.Drawing.Size(120, 22)
        ...
        Me.lblSo_seri.Location = New System.Drawing.Point(752, 32)
        Me.lblSo_seri.Name = "lblSo_seri"
        Me.lblSo_seri.Size = New System.Drawing.Size(52, 17)
        ...
        Me.txtOng_ba.Location = New System.Drawing.Point(115, 30)
        ...
        Me.lblOng_ba.Location = New System.Drawing.Point(10, 32)
        ...
        Me.txtTk.Location = New System.Drawing.Point(115, 103)
        Me.txtTk.Name = "txtTk"
        ...
        Me.lblTk.Location = New System.Drawing.Point(10, 104)
        Me.lblTk.Name = "lblTk"
        Me.lblTk.Size = New System.Drawing.Size(91, 17)
        ...
        Me.lblTen_tk.Location = New System.Drawing.Point(240, 104)
        Me.lblTen_tk.Name = "lblTen_tk"
        Me.lblTen_tk.Size = New System.Drawing.Size(115, 17)
        ...
        Me.txtTk_thue_no.Location = New System.Drawing.Point(134, 464)
        Me.txtTk_thue_no.Name = "txtTk_thue_no"
        Me.txtTk_thue_no.Size = New System.Drawing.Size(120, 22)
        ...
        Me.lblTk_thue.Location = New System.Drawing.Point(29, 466)
        Me.lblTk_thue.Name = "lblTk_thue"
        Me.lblTk_thue.Size = New System.Drawing.Size(56, 17)
        ...
        Me.txtMa_thue.Location = New System.Drawing.Point(134, 440)
        Me.txtMa_thue.Name = "txtMa_thue"
        Me.txtMa_thue.Size = New System.Drawing.Size(36, 22)
        ...
        Me.lblMa_thue.Location = New System.Drawing.Point(29, 442)
        Me.lblMa_thue.Name = "lblMa_thue"
        Me.lblMa_thue.Size = New System.Drawing.Size(59, 17)
        ...
        Me.txtThue_suat.Location = New System.Drawing.Point(-93, 551)
        Me.txtThue_suat.MaxLength = 8
        Me.txtThue_suat.Name = "txtThue_suat"
        Me.txtThue_suat.Size = New System.Drawing.Size(54, 22)
        ...
        Me.txtTk_thue_co.Location = New System.Drawing.Point(259, 464)
        Me.txtTk_thue_co.Name = "txtTk_thue_co"
        Me.txtTk_thue_co.Size = New System.Drawing.Size(120, 22)
        ...
        Me.Label2.Location = New System.Drawing.Point(29, 490)
        ...
        Me.txtMa_kh2.Location = New System.Drawing.Point(134, 488)
        Me.txtMa_kh2.Name = "txtMa_kh2"
        Me.txtMa_kh2.Size = New System.Drawing.Size(120, 22)
        ...
        Me.txtsl_in.Location = New System.Drawing.Point(-169, 547)
        Me.txtsl_in.MaxLength = 8
        Me.txtsl_in.Name = "txtsl_in"
        Me.txtsl_in.Size = New System.Drawing.Size(54, 22)
        ...
        Me.txtNgay_lct.Location = New System.Drawing.Point(877, 54)
        ...
        Me.tbgUpdateInv.ResumeLayout(False)
        Me.tbgUpdateInv.PerformLayout()
...
#End Region
    ...
    Public Sub Print()
        ...
        Dim sMau_HDDT As String = "", sKy_hieu_HDDT As String = "", sSo_ct_HDDT As String = "", isPrintHDDT As String = ""
        If oOption("m_sd_hddt") = "1" Then
            isPrintHDDT = oEIInvoice.CheckPrint(sMau_HDDT, sKy_hieu_HDDT, sSo_ct_HDDT)
        End If
        If ((result2 <> DialogResult.Cancel) AndAlso (print.txtSo_lien.Value > 0)) Then
            ...
            clsprint.oRpt.SetDataSource(ds.Tables.Item("cttmp"))
    ...
    Public Sub RefrehForm()
        ...
        Me.grdHeader.Scatter()
        clsvoucher.clsVoucher.ScatterMemvar(modVoucher.tblMaster.Item(Me.iMasterRow), Me)
        Dim obj2 As Object = ObjectType.AddObj(ObjectType.AddObj("stt_rec = '", modVoucher.tblMaster.Item(Me.iMasterRow).Item("stt_rec")), "'")
        modVoucher.tblDetail.RowFilter = StringType.FromObject(obj2)
        Me.RefreshCharge(1)
        Me.EDTranType()
    ...
    Private Sub RetrieveItemsFromSI()
        If Fox.InList(oVoucher.cAction, New Object() {"New", "Edit"}) Then
            If (StringType.StrCmp(Strings.Trim(Me.txtMa_nvbh.Text), "", False) = 0) Then
                Msg.Alert(oLan.Item("080"), 2)
            Else
                Dim _date As New frmDate2
                ...
                If (_date.ShowDialog = DialogResult.OK) Then
                    ...
                    str3 = (str3 & " AND a.ma_kh LIKE '" & Strings.Trim(_date.txtMa_kh.Text) & "%'")
                    str3 = (str3 & " AND a.ma_nvbh LIKE '" & Strings.Trim(Me.txtMa_nvbh.Text) & "%'")
                    ...
                    'tcSQL += "," + Sql.ConvertVS2SQLType(Me.txtFcode1.Text, "")
                    Dim ds As New DataSet
                    ...
                    Else
                        ...
                        Dim panel As StatusBarPanel = clsvoucher.clsVoucher.AddStb(frmAdd)
                        ...
                        'Me.tblRetrieveDetail.ContextMenu = menu
                        Dim button As New Button
                        button.Visible = True
                        ...
                        Fill2Grid.Fill(modVoucher.sysConn, (Me.tblRetrieveMaster), grdFill, (tbs), (cols), "SIMaster")
                        ...
                        Fill2Grid.Fill(modVoucher.sysConn, (Me.tblRetrieveDetail), grdFill, (style), (cols), "SIDetail4SV")
                        ...
                        If ((button3.Checked And flag) And (count >= 0)) Then
                            index = count
                            Me.txtMa_thue.Text = tblRetrieveDetail(0).Item("ma_thue")
                            Me.txtThue_suat.Value = tblRetrieveDetail(0).Item("thue_suat")
                            Me.txtStatus.Text = "0"
                            Do While (index >= 0)
                        ...
                        tbl = clsvoucher.clsVoucher.Copy2Table(Me.tblRetrieveDetail)
                        ...
                        Do While (index <= num8)
                            ...
                            index += 1
                        Loop
                        clsvoucher.clsVoucher.AppendFrom(tblDetail, tbl)
                        ...
                        If flag Then
                            ...
                            For index = 0 To count - 1
                                tblDetail.Item(index).Item("stt_rec0") = Strings.Format(index + 1, "000")
                            Next
                            ...
                            Do While (index <= num7)
                                ...
                                End If
                                tblDetail(index)("tien_nt2") = Fox.Round(tblDetail(index)("so_luong") * tblDetail(index)("gia_nt2"), num6)
                                tblDetail(index)("gia2") = Fox.Round(tblDetail(index)("gia_nt2") * Me.txtTy_gia.Value, CByte(oVar("m_round_gia")))
                                tblDetail(index)("tien2") = Fox.Round(tblDetail(index)("tien_nt2") * Me.txtTy_gia.Value, CByte(oVar("m_round_tien")))
            ...
            Else
                ...
                If (_frmDate.ShowDialog = DialogResult.OK) Then
                    ...
                    Else
                        ...
                        frmAdd.Controls.Add(gridformtran)
                        Dim grdFill As DataGrid = gridformtran2
                        Fill2Grid.Fill(modVoucher.sysConn, (Me.tblRetrieveMaster), grdFill, (tbs), (cols), "SOMaster")
                        gridformtran2 = grdFill
                        index = 0
                        Do
                            If (Strings.InStr(modVoucher.tbcDetail(index).Format, "0", CompareMethod.Binary) > 0) Then
                        ...
                        cols(2).Alignment = HorizontalAlignment.Right
                        grdFill = gridformtran
                        Fill2Grid.Fill(modVoucher.sysConn, (Me.tblRetrieveDetail), grdFill, (style), (cols), "SODetail4SV")
                        gridformtran = grdFill
                        ...
                        Do While (index <= num8)
                            ...
                            index += 1
                        Loop
                        clsvoucher.clsVoucher.AppendFrom(modVoucher.tblDetail, tbl)
    ...
    Public Sub Save()
        ...
        If (num3 = 0) Then
            ...
            Return
        End If
        If (Me.txtStatus.Text = "2" Or Me.txtStatus.Text = "3") And Sql.GetValue(appConn, "exec sp18_hanno '" + oVoucher.VoucherCode + "','" + Me.txtMa_kh.Text.Replace(",", "''") + "',''," + Conversion.Str(Me.txtT_tt.Value) + "," + Sql.ConvertVS2SQLType(Me.txtNgay_ct.Value, "")) = 0 Then
        ...
        num = 0
        Dim ma_thue As String = ""
        Do While (num <= num14)
            Dim replacement As String = Strings.Trim(StringType.FromObject(tblDetail.Item(num).Item("ma_vt")))
            Dim row As DataRow = Sql.GetRow(appConn, "dmvt", "ma_vt='" + replacement + "' and vt_ton_kho=1")
            If row Is Nothing Then
                num += 1
                Continue Do
            End If
            If (clsfields.isEmpty(RuntimeHelpers.GetObjectValue(tblDetail.Item(num).Item("so_luong")), "N") AndAlso (ObjectType.ObjTst(row.Item("gia_ton"), 3, False) = 0)) Then
                oVoucher.isContinue = False
                Msg.Alert(Strings.Replace(StringType.FromObject(oVoucher.oClassMsg.Item("043")), "%s", replacement, 1, -1, CompareMethod.Binary), 2)
                Return
            End If
            If ma_thue <> row.Item("ma_thue").ToString.Trim And num > 0 Then
                oVoucher.isContinue = False
                Msg.Alert("Hóa đơn tồn tại 2 loại thuế suất khác nhau", 2)
                Return
            End If
            If row.Item("ma_thue").ToString.Trim <> Me.txtMa_thue.Text.Trim Then
                oVoucher.isContinue = False
                Msg.Alert("Thuế suất không đúng như khai báo trong danh mục hàng hóa", 2)
                Return
            End If
            ma_thue = row.Item("ma_thue").ToString.Trim
            num += 1
        Loop
        ...
        If (StringType.StrCmp(Me.txtStatus.Text, "0", False) <> 0) Then
            ...
            If Not oVoucher.CheckDuplVoucherNumber(Fox.PadL(Strings.Trim(Me.txtSo_ct.Text), Me.txtSo_ct.MaxLength), StringType.FromObject(Interaction.IIf((StringType.StrCmp(oVoucher.cAction, "New", False) = 0), "New", Me.cIDNumber))) Then
                ...
                Return
            End If
            If Not clsvoucher.clsVoucher.CheckDuplInvNumber(modVoucher.appConn, modVoucher.sysConn, "1"c, Me.txtSo_ct.Text, Me.txtSo_seri.Text, Me.txtSo_ct, Me.cIDNumber) Then
                oVoucher.isContinue = False
                Return
            End If
        End If
        ...
        Else
            ...
            strsql += ChrW(13) & Me.BeforUpdateSV(Me.cIDNumber, "Edit")
        End If
        ...
        Me.grdHeader.Gather()
        clsvoucher.clsVoucher.GatherMemvar(tblMaster.Item(Me.iMasterRow), Me)
        tblMaster.Item(Me.iMasterRow).Item("so_ct") = Fox.PadL(Strings.Trim(tblMaster.Item(Me.iMasterRow).Item("so_ct")), Me.txtSo_ct.MaxLength)
        If (StringType.StrCmp(oVoucher.cAction, "New", False) = 0) Then
            strsql += clsvoucher.clsVoucher.GenSQLInsert(appConn, Strings.Trim(oVoucherRow.Item("m_phdbf")), tblMaster.Item(Me.iMasterRow).Row)
        Else
            Dim cKey As String = "stt_rec = '" + tblMaster.Item(Me.iMasterRow).Item("stt_rec") + "'"
            strsql += ((clsvoucher.clsVoucher.GenSQLUpdate(appConn, Strings.Trim(oVoucherRow.Item("m_phdbf")), tblMaster.Item(Me.iMasterRow).Row, cKey) & ChrW(13) & GenSQLDelete(Strings.Trim(oVoucherRow.Item("m_ctdbf")), cKey)) & ChrW(13) & GenSQLDelete("ctcp20", cKey))
        End If
        ...
        Do While (num <= num8)
            If (ObjectType.ObjTst(tblDetail.Item(num).Item("stt_rec"), Interaction.IIf((StringType.StrCmp(oVoucher.cAction, "New", False) = 0), "", RuntimeHelpers.GetObjectValue(tblMaster.Item(Me.iMasterRow).Item("stt_rec"))), False) = 0) Then
                ...
                Me.grdDetail.Update()
                strsql += ChrW(13) & clsvoucher.clsVoucher.GenSQLInsert(appConn, Strings.Trim(oVoucherRow.Item("m_ctdbf")), tblDetail.Item(num).Row)
            End If
            num += 1
        Loop
        ...
        Do While (num <= num6)
            ...
            Me.grdCharge.Update()
            strsql += ChrW(13) & clsvoucher.clsVoucher.GenSQLInsert(appConn, "ctcp20", tblCharge.Item(num).Row)
            num += 1
        Loop
        ...
        Try
            Dim row As DataRow = DirectCast(Sql.GetRow((appConn), "dmkh", ("ma_kh = '" & Me.txtFcode1.Text & "'")), DataRow)
        ...
        If ((StringType.StrCmp(Me.txtStatus.Text, "0", False) <> 0) AndAlso (StringType.StrCmp(modVoucher.cTaxCode, "", False) = 0)) Then
            ...
            _frmCust.ShowDialog()
        End If
        strsql += ChrW(13) + "EXEC fs_UpdateOutputTaxInfo "
        strsql += "'" + tblMaster.Item(Me.iMasterRow).Item("stt_rec") + "'"
        strsql += ", " + Sql.ConvertVS2SQLType(Me.txtNgay_ct.Value, "")
        strsql += ", " + Sql.ConvertVS2SQLType(Me.txtNgay_lct.Value, "")
        strsql += ", N'" + Strings.Replace(cCustName, "'", "''") + "'"
        strsql += ", N'" + Strings.Replace(cAddress, "'", "''") + "'"
        strsql += ", N'" + Strings.Replace(cTaxCode, "'", "''") + "'"
        ...
        strsql += ChrW(13) + Me.AfterUpdateSV(Conversions.ToString(modVoucher.tblMaster.Item(Me.iMasterRow).Item("stt_rec")), "Save")
        If Sql.SQLExecute((modVoucher.appConn), strsql) Is Nothing Then
        ...
        clsvoucher.clsVoucher.SaveLocalDataView(modVoucher.tblDetail)
        oVoucher.RefreshStatus(Me.cboStatus)
        xtabControl.ReadOnlyTabControls(True, Me.tbDetail)
    End Sub
    ...
    Private Sub txtC_Enter(ByVal sender As Object, ByVal e As EventArgs)
        If Not Fox.InList(oVoucher.cAction, "New", "Edit") Then
            LateBinding.LateSet(sender, Nothing, "ReadOnly", New Object() {True}, Nothing)
        ElseIf Information.IsDBNull(tblCharge.Item(Me.grdCharge.CurrentRowIndex).Item("ma_cp")) Then
            LateBinding.LateSet(sender, Nothing, "ReadOnly", New Object() {True}, Nothing)
        Else
            Dim sLeft As String = Strings.Trim(tblCharge.Item(Me.grdCharge.CurrentRowIndex).Item("ma_cp"))
            sender.ReadOnly = (sLeft = "")
        End If
    End Sub
    ...
    Private Sub txtMa_kh_valid(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If (oVoucher.cAction = "New" Or oVoucher.cAction = "Edit") And (Not row Is Nothing) Then
            ...
            End If
        End If
        If Me.txtFcode1.Text = "" Then
            Me.txtFcode1.Text = Me.txtMa_kh.Text
            Me.lblFname1.Text = Me.lblTen_kh.Text
        End If
        If Me.txtTk.Text = "" Then
            Me.txtTk.Text = "131VP"
            Me.txtTk_thue_no.Text = "131VP"
        End If
    End Sub
    ...
    Private Sub ValidObjects(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If Not Fox.InList(sLeft.ToLower, "ma_vt", "ma_kho", "so_luong", "dvt") Then
            Return
        End If
        ...
        For nWordPosition = 1 To num9
            With tblDetail.Item(Me.grdDetail.CurrentRowIndex)
                ...
                If Not Information.IsDBNull(RuntimeHelpers.GetObjectValue(ds.Tables.Item(0).Rows.Item(0).Item(str))) And Not (str = "gia_nt2" And .Item("gia_nt2") <> 0) Then
                    .Item(str) = RuntimeHelpers.GetObjectValue(ds.Tables.Item(0).Rows.Item(0).Item(str))
                End If
            End With
        Next
        With tblDetail.Item(Me.grdDetail.CurrentRowIndex)
    ...
    Public Sub View()
        ...
        frmAdd.Controls.Add(gridformtran)
        Dim grdFill As DataGrid = gridformtran2
        Fill2Grid.Fill(sysConn, tblMaster, grdFill, (tbs), (cols), "SVMaster")
        gridformtran2 = grdFill
        ...
        cols(2).Alignment = HorizontalAlignment.Right
        grdFill = gridformtran
        Fill2Grid.Fill(sysConn, tblDetail, grdFill, (style), (cols), "SVDetail")
        gridformtran = grdFill
    ...
    Private Sub WhenItemLeave(ByVal sender As Object, ByVal e As EventArgs)
        ...
        With tblDetail.Item(Me.grdDetail.CurrentRowIndex)
            ...
            If row.Item("ma_thue") <> "" Then
                If row.Item("ma_thue") <> Me.txtMa_thue.Text And Not Sql.GetRow(appConn, "dmthue", "ma_thue = '" + row.Item("ma_thue") + "'") Is Nothing Then
                    Me.txtMa_thue.Text = row.Item("ma_thue")
                    Me.txtThue_suat.Value = DoubleType.FromObject(Sql.GetValue((modVoucher.appConn), "dmthue", "thue_suat", "ma_thue = '" + row.Item("ma_thue") + "'"))
                    Me.txtTk_thue_co.Text = StringType.FromObject(Sql.GetValue((modVoucher.appConn), "dmthue", "tk_thue_co", "ma_thue = '" + row.Item("ma_thue") + "'"))
                    Me.RecalcTax(2)
    ...
    Private Sub txtNgay_lct_GotFocus(sender As Object, e As EventArgs) Handles txtNgay_lct.GotFocus
        If oVoucher.cAction = "Edit" Or oVoucher.cAction = "New" Then
            Me.txtNgay_lct.ReadOnly = False
        End If
    End Sub
    Private Sub txtMa_kh_GotFocus(sender As Object, e As EventArgs) Handles txtMa_kh.GotFocus
        If oVoucher.cAction = "Edit" Or oVoucher.cAction = "New" Then
            Me.txtMa_kh.ReadOnly = False
        End If
    End Sub
    Private Sub Bohet(ByVal sender As Object, ByVal e As EventArgs)
        Dim count As Integer = Me.tblRetrieveDetail.Count
        Dim num3 As Integer = (count - 1)
        Dim i As Integer = 0
        Do While (i <= num3)
            Me.tblRetrieveDetail.Item(i).Item("sl_xuat0") = 0
            i += 1
        Loop
    End Sub
    ...
    Private Sub Chonhet(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim i As Integer = 0
        Do While (i <= num3)
            Me.tblRetrieveDetail.Item(i).Item("sl_xuat0") = Me.tblRetrieveDetail.Item(i).Item("so_luong") - Me.tblRetrieveDetail.Item(i).Item("sl_hd")
            i += 1
        Loop
    End Sub
End Class
