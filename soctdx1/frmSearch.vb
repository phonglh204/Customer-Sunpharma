...
Public Class frmSearch
    ...
    Private Sub cmdOk_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdOk.Click
        ...
        Do While (num2 <= num8)
            If ((Strings.InStr(StringType.FromObject(Me.Controls.Item(num2).Tag), "Master", 0) > 0) Or (Strings.InStr(StringType.FromObject(Me.Controls.Item(num2).Tag), "Detail", 0) > 0)) Then
                ...
                If (Strings.InStr(Me.Controls.Item(num2).GetType.ToString.ToLower, "libscontrol.txtnumeric", 0) > 0) Then
                    ...
                    flag = True
                End If
                If (Strings.InStr(Me.Controls.Item(num2).GetType.ToString.ToLower, "libscontrol.txtdate", 0) > 0) Then
                    ...
                    If (ObjectType.ObjTst(_date.Text, Fox.GetEmptyDate, False) <> 0) Then
                        str2 = Strings.Replace(str2, "%d", StringType.FromObject(Sql.ConvertVS2SQLType(_date.Value, "")), 1, -1, 0)
                    Else
                        str2 = ""
                    End If
                    flag = True
        ...
        Do While (i <= num7)
            ...
            Do While (num2 <= num6)
                If ((Strings.InStr(StringType.FromObject(Me.tabFilter.TabPages.Item(i).Controls.Item(num2).Tag), "Master", 0) > 0) Or (Strings.InStr(StringType.FromObject(Me.tabFilter.TabPages.Item(i).Controls.Item(num2).Tag), "Detail", 0) > 0)) Then
                    ...
                    If (Strings.InStr(Me.tabFilter.TabPages.Item(i).Controls.Item(num2).GetType.ToString.ToLower, "libscontrol.txtnumeric", 0) > 0) Then
                        ...
                        flag = True
                    End If
                    If (Strings.InStr(Me.tabFilter.TabPages.Item(i).Controls.Item(num2).GetType.ToString.ToLower, "libscontrol.txtdate", 0) > 0) Then
    ...
    Private Sub frmSearch_Load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim oCust As New vouchersearchlibobj(Me.txtMa_kh, Me.lblTen_kh, modVoucher.sysConn, modVoucher.appConn, "dmkh", "ma_kh", "ten_kh", "Customer", "1=1", True, Me.cmdCancel)
